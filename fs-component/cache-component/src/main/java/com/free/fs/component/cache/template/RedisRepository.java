package com.free.fs.component.cache.template;
...
public class RedisRepository {
    ...
    public Boolean execute(RedisScript<Boolean> redisScript, List<Object> keys, int count, int period) {
        return redisTemplate.execute(redisScript, keys, count, period);
    }
     ...
     * @return the set
     */
    public Set<Object> keys(final String keyPatten) {
     ...
     */
    public HashOperations<Object, String, Object> opsForHash() {
